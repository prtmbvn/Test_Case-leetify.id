...
<div class="max-w-xl rounded-lg border border-amber-200/70 bg-white p-4 shadow-sm animate-fade-up ">
  ...
  <form method="post" action="{{ route('attendance.checkin.store') }}" class="grid gap-4">
    @csrf
    ...
    <div class="flex gap-2">
      <button type="submit"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M3 12h11m0 0-3-3m3 3-3 3M18 7v10"/>
        </svg>
        Check-in Sekarang
      </button>
