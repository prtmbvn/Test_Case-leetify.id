...
<form method="post" action="{{ route('attendance.checkin.store') }}" class="grid gap-4 max-w-xl">
  @csrf
  <div>
  ...
  <div class="flex gap-2">
    <button class="px-4 py-2 border rounded hover:bg-gray-50">Check-in Sekarang</button>
